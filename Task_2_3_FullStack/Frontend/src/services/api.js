...
export const reviewService = {
    getByItem: (itemId) => api.get(`/reviews/${itemId}`).then(res => mapId(res.data)),
    create: (data) => api.post('/reviews', data).then(res => mapId(res.data)),
};

export const subscriptionService = {
    subscribe: (email) => api.post('/subscriptions', { email }).then(res => res.data),
};

export const bookingService = {
    create: (data) => api.post('/bookings', data).then(res => mapId(res.data)),
    getMyBookings: () => api.get('/bookings/my-bookings').then(res => mapId(res.data)),
};
